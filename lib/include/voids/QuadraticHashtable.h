...
VOIDS_API KVPair *QuadHash_insert(QuadHashtable *table,
                                  void *pData,
                                  void *pKey,
                                  size_t key_size,
...
VOIDS_API void *QuadHash_delete(QuadHashtable *table,
                                void *pKey,
                                size_t key_size,
                                vdsErrCode *err);

VOIDS_API void *QuadHash_find(QuadHashtable *table,
                              void *pKey,
                              size_t key_size,
                              vdsErrCode *err);
